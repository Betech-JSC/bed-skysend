    ...
    <div class="md:flex md:flex-col">
      <div class="md:flex md:flex-col md:h-screen">
        <div class="md:flex md:shrink-0">
          <div class="flex items-center justify-between px-6 py-4 bg-indigo-900 md:shrink-0 md:justify-center md:w-56 text-white">
            <Link class="mt-1" href="/admin">
              <div class="text-xl font-bold">SkySend Admin</div>
            </Link>
          ...
          <div class="md:text-md flex items-center justify-between p-4 w-full text-sm bg-white border-b md:px-12 md:py-0">
            <div class="mr-4 mt-1">Admin Panel</div>
            <dropdown class="mt-1" placement="bottom-end">
              ...
              <template #dropdown>
                <div class="mt-2 py-2 text-sm bg-white rounded shadow-xl">
                  <Link class="block px-6 py-2 hover:text-white hover:bg-indigo-500" href="/admin/logout" method="post" as="button">Logout</Link>
                </div>
              </template>
            </dropdown>
          </div>
        ...
        <div class="md:flex md:grow md:overflow-hidden">
          <admin-main-menu class="hidden shrink-0 p-12 w-56 bg-indigo-800 overflow-y-auto md:block" />
...
import AdminMainMenu from '@/Shared/AdminMainMenu.vue'
